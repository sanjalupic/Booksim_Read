...
import com.example.booksim_read.databinding.ActivityRegisterBinding
...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //init progress dialog, while creating account | Register user
    ...
    private fun createUserAccount() {
        ...
        //show process
        progressDialg.setMessage("Creating Account...")
        progressDialg.show()
    ...
    private fun updateUserInfo() {
        // 4) Save User Info - Firebase Realtime Database
        progressDialg.setMessage("Saving user info...")
        ...
        val hashMap: HashMap<String, Any?> = java.util.HashMap()
        hashMap["uid"] = uid
        hashMap["email"] = email
        hashMap["name"] = name
        hashMap["profileImage"] = "" //add empty, will do in profile edit
        hashMap["userType"] = "user" //possible values are user/admin, will make admin manually
