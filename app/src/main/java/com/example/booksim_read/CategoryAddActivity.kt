...
import com.example.booksim_read.databinding.ActivityCategoryAddBinding
...
class CategoryAddActivity : AppCompatActivity() {
    ...
    private fun addCategoryFirebase() {
        ...
        hashMap["id"]="$timestamp" //put in strinf quotes because timestamp is in double, we need in string for id
